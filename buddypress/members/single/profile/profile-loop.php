                ...
                <header class="entry-header profile-loop-header profile-header flex align-items-center">
                    ...
                    if (bp_is_my_profile()) {
                        ...
                        <a href="<?php echo esc_url($edit_profile_link . bp_get_the_profile_group_id()); ?>"
                            class="push-right button outline small"><?php esc_attr_e('Edit', 'buddyboss-theme'); ?></a>
                        <?php
                    }
                    ?>
                </header>
                <div class="bp-widget <?php bp_the_profile_group_slug(); ?>">
                    <table class="profile-fields bp-tables-user test">
                        ...
                        endwhile;
                        $default_ref_id = get_user_meta(wp_get_current_user()->ID, 'default_ref_id', true);
                        ?>
                            <tr class="field_1 field_first-name field_order_0 required-field visibility-public field_type_textbox">
                                <td class="label">Affiliate ID</td>
                                <td class="data">
                                    <p>
                                        <?php echo $default_ref_id; ?>
                                    </p>
                                </td>
                            </tr>
                            <?php
